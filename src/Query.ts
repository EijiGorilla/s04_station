...
export async function generateChartData(station: any) {
  ...
  const others_comp = mass[1] + rooms[1] + specialityEquipment[1] + stairs[1];
  const others_incomp = mass[0] + rooms[0] + specialityEquipment[0] + stairs[0];
  const others_delay = mass[2] + rooms[2] + specialityEquipment[2] + stairs[2];
